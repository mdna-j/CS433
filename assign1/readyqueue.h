...
private:
    ...
    PCB** heap;      // Dynamic array to store the heap elements
    int capacity;   //  Maximum size of the heap
    int count;      // Current number of elements in the heap


    // Purpose: Moves a newly inserted element up to maintain heap property.
    void bubbleUp(int index);

    //Purpose:: Moves an element down to maintain heap property after removal.
